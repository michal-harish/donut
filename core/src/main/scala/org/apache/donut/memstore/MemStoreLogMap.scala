 ...
 */
class MemStoreLogMap(val maxSizeInMb: Int, val segmentSizeMb: Int) extends MemStore {

  val map = new ConcurrentLogHashMap(maxSizeInMb, segmentSizeMb, compressMinBlockSize = 131070, indexLoadFactor = 0.87)
